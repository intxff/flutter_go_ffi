...
class GoFFI {
  ...
  GoFFI(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _SendTenNumsPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>('SendTenNums');
  late final _SendTenNums = _SendTenNumsPtr.asFunction<void Function(int)>();
}
...
final class Latency extends ffi.Struct {
